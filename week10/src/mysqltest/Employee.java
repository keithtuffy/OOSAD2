...
public class Employee {
	...
	public static Employee loadEmployeeByORMID(int id) throws PersistentException {
		try {
			PersistentSession session = mysqltest.Week10PersistentManager.instance().getSession();
	...
	public static Employee loadEmployeeByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Employee) session.load(mysqltest.Employee.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Employee getEmployeeByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Employee) session.get(mysqltest.Employee.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Employee loadEmployeeByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Employee) session.load(mysqltest.Employee.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Employee getEmployeeByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Employee) session.get(mysqltest.Employee.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryEmployee(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From mysqltest.Employee as Employee");
		if (condition != null)
	...
	public static Employee createEmployee() {
		return new mysqltest.Employee();
	}
	
	public boolean save() throws PersistentException {
		try {
			mysqltest.Week10PersistentManager.instance().saveObject(this);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean delete() throws PersistentException {
		try {
			mysqltest.Week10PersistentManager.instance().deleteObject(this);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean refresh() throws PersistentException {
		try {
			mysqltest.Week10PersistentManager.instance().getSession().refresh(this);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean evict() throws PersistentException {
		try {
			mysqltest.Week10PersistentManager.instance().getSession().evict(this);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
